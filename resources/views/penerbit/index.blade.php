    ...
    <main class="flex-grow container mx-auto mt-8 md:mt-12 max-w-screen-xl p-4 md:p-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <button type="button" data-modal-target="create-penerbit-modal" data-modal-toggle="create-penerbit-modal"
                class="inline-flex items-center px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg shadow-md transition duration-150 ease-in-out">
