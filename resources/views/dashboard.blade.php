...
<body class="flex flex-col min-h-screen bg-gray-50 text-gray-800">
    ...
    <main class="flex-grow container mx-auto mt-8 md:mt-12 max-w-screen-xl p-4 md:p-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <button onclick="openModal('create-kategori-modal')" class="w-full group flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-amber-500 hover:bg-amber-50 transition cursor-pointer text-left">
                            ...
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </button>
                        ...
                        <button onclick="openModal('create-penerbit-modal')" class="w-full group flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-emerald-500 hover:bg-emerald-50 transition cursor-pointer text-left">
                            ...
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </button>
    ...
    <script>
        function openModal(modalId) {
            ...
            if (modal) {
                ...
                document.body.style.overflow = 'hidden'; // Kunci scroll body saat modal buka
            }
        }
        ...
        function closeModal(modalId) {
            ...
            if (modal) {
                ...
                document.body.style.overflow = 'auto'; // Buka scroll body
            }
        }
    </script>
