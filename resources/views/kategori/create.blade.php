    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white border border-gray-200 rounded-lg shadow-sm p-4 md:p-6 text-left">
            ...
            <div class="flex items-center justify-between border-b border-gray-200 pb-4 md:pb-5">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-9 h-9 ms-auto inline-flex justify-center items-center" data-modal-hide="create-kategori-modal">
            ...
            <form action="{{ route('kategori.store') }}" method="POST">
                ...
                <div class="flex items-center space-x-4 border-t border-gray-200 pt-4">
                    ...
                    <button data-modal-hide="create-kategori-modal" type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 hover:text-blue-700">Batal</button>
                </div>
            </form>
        </div>
    </div>
